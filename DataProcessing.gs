function DataImporter()
{
  ...
  var importarray = IMPORTJSONAPI("https://api.steampowered.com/IPlayerService/GetOwnedGames/v0001/?key=" + APIKEY + "&steamid="+ USERID +"&include_appinfo=1&include_played_free_games=1&include_free_sub=0&skip_unvetted_apps=0", "$.response.games[*]", "appid, name, playtime_forever, playtime_2weeks");
